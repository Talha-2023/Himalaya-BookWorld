...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li className="dark:hover:bg-gray-700 rounded">
        <Link className=" dark:focus:text-white" to={"/course"}>
          Course
        </Link>
      </li>
      <li className="dark:hover:bg-gray-700 rounded">
  ...
  return (
    <>
      <div
        className={` dark:text-[#e5e7eb] dark:bg-[#1E232A] max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 duration-500 z-10 ${
          sticky
            ? " shadow-inner  dark:bg-[#2B3440] bg-slate-200 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className="navbar ">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div>
              <a
                className="dark:bg-[#2B3440] dark:text-[#A6ADBB] flex gap-1.5
                border-white border dark:border-gray-800 border-2		  px-3 py-2 rounded-md border bg-slate-200 hover:bg-slate-300 hover:dark:bg-[#445163] duration-300 cursor-pointer"
                onClick={() =>
